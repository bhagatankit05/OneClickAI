    ...
    return (
        <div className=' px-4 sm:px-20 xl:px-32 my-24'>
            <div className='text-center'>
                <h2 className='text-slate-700 text-[42px] font-semibold'>Your AI Powerhouse</h2>
                <p className='text-gray-500 max-w-lg mx-auto'>Unleash the full potential of AI to create, design, and innovate — <br />all in one place.</p>
            </div>
